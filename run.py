...
def main(workdir_list):
  ...
  iplib.basic_box_plot(data_list=isotype_list,
               ...
               size_x=12,size_y=8,y_lim=1.0,y_label='Frequency',has_jitter=True,save=workdir_list[-1]+'Isotype.png')

  iplib.basic_box_plot(data_list=gini_list,
               x_labels=['M','D','G3','G1','A1','G2','G4','A2','All'],colors = ['b','r','g','orange','purple','brown'],
               size_x=12,size_y=8,y_lim=1.0,y_label='Clonality',has_jitter=True,save=workdir_list[-1]+'Clonality.png')
